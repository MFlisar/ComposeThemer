 ...
 *
 * all 3 colors set to material yellow 500
 *
 */
object ComposeThemeYellow {
    ...
    private val md_theme_light_secondary = Color(0xFF5B6300)
    private val md_theme_light_onSecondary = Color(0xFFFFFFFF)
    private val md_theme_light_secondaryContainer = Color(0xFFDDED49)
    private val md_theme_light_onSecondaryContainer = Color(0xFF1A1D00)
    private val md_theme_light_tertiary = Color(0xFF5B6300)
    private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
    private val md_theme_light_tertiaryContainer = Color(0xFFDDED49)
    private val md_theme_light_onTertiaryContainer = Color(0xFF1A1D00)
    ...
    private val md_theme_dark_secondary = Color(0xFFC1D02C)
    private val md_theme_dark_onSecondary = Color(0xFF2F3300)
    private val md_theme_dark_secondaryContainer = Color(0xFF444B00)
    private val md_theme_dark_onSecondaryContainer = Color(0xFFDDED49)
    private val md_theme_dark_tertiary = Color(0xFFC1D02C)
    private val md_theme_dark_onTertiary = Color(0xFF2F3300)
    private val md_theme_dark_tertiaryContainer = Color(0xFF444B00)
    private val md_theme_dark_onTertiaryContainer = Color(0xFFDDED49)
