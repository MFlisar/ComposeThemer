 ...
 *
 * all 3 colors set to material red 500
 *
 */
object ComposeThemeRed {
    ...
    private val md_theme_light_secondary = Color(0xFFBB1614)
    private val md_theme_light_onSecondary = Color(0xFFFFFFFF)
    private val md_theme_light_secondaryContainer = Color(0xFFFFDAD5)
    private val md_theme_light_onSecondaryContainer = Color(0xFF410001)
    private val md_theme_light_tertiary = Color(0xFFBB1614)
    private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
    private val md_theme_light_tertiaryContainer = Color(0xFFFFDAD5)
    private val md_theme_light_onTertiaryContainer = Color(0xFF410001)
    ...
    private val md_theme_dark_secondary = Color(0xFFFFB4A9)
    private val md_theme_dark_onSecondary = Color(0xFF690002)
    private val md_theme_dark_secondaryContainer = Color(0xFF930005)
    private val md_theme_dark_onSecondaryContainer = Color(0xFFFFDAD5)
    private val md_theme_dark_tertiary = Color(0xFFFFB4A9)
    private val md_theme_dark_onTertiary = Color(0xFF690002)
    private val md_theme_dark_tertiaryContainer = Color(0xFF930005)
