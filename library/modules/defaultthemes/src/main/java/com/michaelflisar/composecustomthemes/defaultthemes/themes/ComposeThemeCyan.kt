 ...
 *
 * all 3 colors set to material cyan 500
 *
 */
object ComposeThemeCyan {
    ...
    private val md_theme_light_secondary = Color(0xFF006876)
    private val md_theme_light_onSecondary = Color(0xFFFFFFFF)
    private val md_theme_light_secondaryContainer = Color(0xFFA1EFFF)
    private val md_theme_light_onSecondaryContainer = Color(0xFF001F25)
    private val md_theme_light_tertiary = Color(0xFF006876)
    private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
    private val md_theme_light_tertiaryContainer = Color(0xFFA1EFFF)
    ...
    private val md_theme_dark_secondary = Color(0xFF44D8F1)
    private val md_theme_dark_onSecondary = Color(0xFF00363E)
    private val md_theme_dark_secondaryContainer = Color(0xFF004E59)
    private val md_theme_dark_onSecondaryContainer = Color(0xFFA1EFFF)
    private val md_theme_dark_tertiary = Color(0xFF44D8F1)
    private val md_theme_dark_onTertiary = Color(0xFF00363E)
    private val md_theme_dark_tertiaryContainer = Color(0xFF004E59)
    private val md_theme_dark_onTertiaryContainer = Color(0xFFA1EFFF)
