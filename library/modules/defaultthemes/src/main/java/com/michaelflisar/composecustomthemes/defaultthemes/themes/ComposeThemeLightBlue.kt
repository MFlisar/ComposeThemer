 ...
 *
 * all 3 colors set to material light blue 500
 *
 */
object ComposeThemeLightBlue {
    ...
    private val md_theme_light_secondary = Color(0xFF006493)
    private val md_theme_light_onSecondary = Color(0xFFFFFFFF)
    private val md_theme_light_secondaryContainer = Color(0xFFCAE6FF)
    private val md_theme_light_onSecondaryContainer = Color(0xFF001E30)
    private val md_theme_light_tertiary = Color(0xFF006493)
    ...
    private val md_theme_dark_secondary = Color(0xFF8DCDFF)
    private val md_theme_dark_onSecondary = Color(0xFF00344F)
    private val md_theme_dark_secondaryContainer = Color(0xFF004B70)
    private val md_theme_dark_onSecondaryContainer = Color(0xFFCAE6FF)
    private val md_theme_dark_tertiary = Color(0xFF8DCDFF)
    private val md_theme_dark_onTertiary = Color(0xFF00344F)
    private val md_theme_dark_tertiaryContainer = Color(0xFF004B70)
