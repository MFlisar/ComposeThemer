 ...
 *
 * all 3 colors set to material blue 500
 *
 */
object ComposeThemeBlue {
    ...
    private val md_theme_light_secondary = Color(0xFF0061A4)
    private val md_theme_light_onSecondary = Color(0xFFFFFFFF)
    private val md_theme_light_secondaryContainer = Color(0xFFD1E4FF)
    private val md_theme_light_onSecondaryContainer = Color(0xFF001D36)
    private val md_theme_light_tertiary = Color(0xFF0061A4)
    private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
    private val md_theme_light_tertiaryContainer = Color(0xFFD1E4FF)
    private val md_theme_light_onTertiaryContainer = Color(0xFF001D36)
    ...
    private val md_theme_dark_secondary = Color(0xFF9ECAFF)
    private val md_theme_dark_onSecondary = Color(0xFF003258)
    private val md_theme_dark_secondaryContainer = Color(0xFF00497D)
    private val md_theme_dark_onSecondaryContainer = Color(0xFFD1E4FF)
    private val md_theme_dark_tertiary = Color(0xFF9ECAFF)
    private val md_theme_dark_onTertiary = Color(0xFF003258)
    private val md_theme_dark_tertiaryContainer = Color(0xFF00497D)
    private val md_theme_dark_onTertiaryContainer = Color(0xFFD1E4FF)
