 ...
 *
 * all 3 colors set to material amber 500
 *
 */
object ComposeThemeAmber {
    ...
    private val md_theme_light_secondary = Color(0xFF785900)
    private val md_theme_light_onSecondary = Color(0xFFFFFFFF)
    private val md_theme_light_secondaryContainer = Color(0xFFFFDF9E)
    private val md_theme_light_onSecondaryContainer = Color(0xFF261A00)
    private val md_theme_light_tertiary = Color(0xFF785900)
    private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
    private val md_theme_light_tertiaryContainer = Color(0xFFFFDF9E)
    ...
    private val md_theme_dark_secondary = Color(0xFFFABD00)
    private val md_theme_dark_onSecondary = Color(0xFF3F2E00)
    private val md_theme_dark_secondaryContainer = Color(0xFF5B4300)
    private val md_theme_dark_onSecondaryContainer = Color(0xFFFFDF9E)
    private val md_theme_dark_tertiary = Color(0xFFFABD00)
    private val md_theme_dark_onTertiary = Color(0xFF3F2E00)
    private val md_theme_dark_tertiaryContainer = Color(0xFF5B4300)
    private val md_theme_dark_onTertiaryContainer = Color(0xFFFFDF9E)
