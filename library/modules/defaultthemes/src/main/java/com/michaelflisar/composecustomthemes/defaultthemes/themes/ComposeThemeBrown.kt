 ...
 *
 * all 3 colors set to material brown 500
 *
 */
object ComposeThemeBrown {
    ...
    private val md_theme_light_secondary = Color(0xFF9A4522)
    ...
    private val md_theme_light_tertiary = Color(0xFF9A4522)
    private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
    private val md_theme_light_tertiaryContainer = Color(0xFFFFDBCF)
    private val md_theme_light_onTertiaryContainer = Color(0xFF380D00)
    ...
    private val md_theme_dark_secondaryContainer = Color(0xFF7B2E0D)
    private val md_theme_dark_onSecondaryContainer = Color(0xFFFFDBCF)
    private val md_theme_dark_tertiary = Color(0xFFFFB59A)
    private val md_theme_dark_onTertiary = Color(0xFF5B1B00)
    private val md_theme_dark_tertiaryContainer = Color(0xFF7B2E0D)
