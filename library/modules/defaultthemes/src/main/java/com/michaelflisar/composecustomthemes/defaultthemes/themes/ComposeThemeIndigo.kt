 ...
 *
 * all 3 colors set to material indigo 500
 *
 */
object ComposeThemeIndigo {
    ...
    private val md_theme_light_secondary = Color(0xFF4355B9)
    private val md_theme_light_onSecondary = Color(0xFFFFFFFF)
    private val md_theme_light_secondaryContainer = Color(0xFFDEE0FF)
    private val md_theme_light_onSecondaryContainer = Color(0xFF00105C)
    private val md_theme_light_tertiary = Color(0xFF4355B9)
    private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
    private val md_theme_light_tertiaryContainer = Color(0xFFDEE0FF)
    private val md_theme_light_onTertiaryContainer = Color(0xFF00105C)
    ...
    private val md_theme_dark_secondary = Color(0xFFBAC3FF)
    private val md_theme_dark_onSecondary = Color(0xFF08218A)
    private val md_theme_dark_secondaryContainer = Color(0xFF293CA0)
    private val md_theme_dark_onSecondaryContainer = Color(0xFFDEE0FF)
    private val md_theme_dark_tertiary = Color(0xFFBAC3FF)
    private val md_theme_dark_onTertiary = Color(0xFF08218A)
    private val md_theme_dark_tertiaryContainer = Color(0xFF293CA0)
    private val md_theme_dark_onTertiaryContainer = Color(0xFFDEE0FF)
