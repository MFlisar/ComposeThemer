...
internal object Color3 {
    ...
    val md_theme_dark_onSecondary = Color(0xFF1A129A)
    val md_theme_dark_secondaryContainer = Color(0xFF3433AF)
    ...
    val md_theme_dark_inversePrimary = Color(0xFF9C404E)
