 ...
 *
 * all 3 colors set to material pink 500
 *
 */
object ComposeThemePink {
    ...
    private val md_theme_light_secondary = Color(0xFFBC004B)
    private val md_theme_light_onSecondary = Color(0xFFFFFFFF)
    private val md_theme_light_secondaryContainer = Color(0xFFFFD9DE)
    private val md_theme_light_onSecondaryContainer = Color(0xFF400014)
    private val md_theme_light_tertiary = Color(0xFFBC004B)
    private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
    private val md_theme_light_tertiaryContainer = Color(0xFFFFD9DE)
    private val md_theme_light_onTertiaryContainer = Color(0xFF400014)
    ...
    private val md_theme_dark_secondary = Color(0xFFFFB2BE)
    private val md_theme_dark_onSecondary = Color(0xFF660025)
    private val md_theme_dark_secondaryContainer = Color(0xFF900038)
    private val md_theme_dark_onSecondaryContainer = Color(0xFFFFD9DE)
    private val md_theme_dark_tertiary = Color(0xFFFFB2BE)
    private val md_theme_dark_onTertiary = Color(0xFF660025)
    private val md_theme_dark_tertiaryContainer = Color(0xFF900038)
    private val md_theme_dark_onTertiaryContainer = Color(0xFFFFD9DE)
