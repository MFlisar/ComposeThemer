 ...
 *
 * all 3 colors set to material orange 500
 *
 */
object ComposeThemeOrange {
    ...
    private val md_theme_light_secondary = Color(0xFF8B5000)
    private val md_theme_light_onSecondary = Color(0xFFFFFFFF)
    private val md_theme_light_secondaryContainer = Color(0xFFFFDCBE)
    private val md_theme_light_onSecondaryContainer = Color(0xFF2C1600)
    private val md_theme_light_tertiary = Color(0xFF8B5000)
    private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
    private val md_theme_light_tertiaryContainer = Color(0xFFFFDCBE)
    private val md_theme_light_onTertiaryContainer = Color(0xFF2C1600)
    ...
    private val md_theme_dark_secondary = Color(0xFFFFB870)
    private val md_theme_dark_onSecondary = Color(0xFF4A2800)
    private val md_theme_dark_secondaryContainer = Color(0xFF693C00)
    private val md_theme_dark_onSecondaryContainer = Color(0xFFFFDCBE)
    private val md_theme_dark_tertiary = Color(0xFFFFB870)
    private val md_theme_dark_onTertiary = Color(0xFF4A2800)
    private val md_theme_dark_tertiaryContainer = Color(0xFF693C00)
    private val md_theme_dark_onTertiaryContainer = Color(0xFFFFDCBE)
