 ...
 *
 * all 3 colors set to material purple 500
 *
 */
object ComposeThemePurple {
    ...
    private val md_theme_light_secondary = Color(0xFF9A25AE)
    private val md_theme_light_onSecondary = Color(0xFFFFFFFF)
    private val md_theme_light_secondaryContainer = Color(0xFFFFD6FE)
    private val md_theme_light_onSecondaryContainer = Color(0xFF35003F)
    private val md_theme_light_tertiary = Color(0xFF9A25AE)
    private val md_theme_light_onTertiary = Color(0xFFFFFFFF)
    private val md_theme_light_tertiaryContainer = Color(0xFFFFD6FE)
    private val md_theme_light_onTertiaryContainer = Color(0xFF35003F)
    ...
    private val md_theme_dark_secondary = Color(0xFFF9ABFF)
    private val md_theme_dark_onSecondary = Color(0xFF570066)
    private val md_theme_dark_secondaryContainer = Color(0xFF7B008F)
    private val md_theme_dark_onSecondaryContainer = Color(0xFFFFD6FE)
    private val md_theme_dark_tertiary = Color(0xFFF9ABFF)
    private val md_theme_dark_onTertiary = Color(0xFF570066)
    private val md_theme_dark_tertiaryContainer = Color(0xFF7B008F)
    private val md_theme_dark_onTertiaryContainer = Color(0xFFFFD6FE)
