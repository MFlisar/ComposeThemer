 ...
 * ~ green, green, orange
 */
internal object ColorGreenGreenOrange {
    ...
    val md_theme_light_secondaryContainer = Color(0xFF77FF61)
    ...
    val md_theme_dark_secondary = Color(0xFF02E600)
    val md_theme_dark_onSecondary = Color(0xFF013A00)
    val md_theme_dark_secondaryContainer = Color(0xFF015300)
    val md_theme_dark_onSecondaryContainer = Color(0xFF77FF61)
