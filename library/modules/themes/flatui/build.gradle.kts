...
val description = "provides a list of themes based on the 20 flatui colors (each one in 5 variations)"

// Module
val artifactId = "themes-flatui"
val androidNamespace = "com.michaelflisar.composethemer.themes.flatui"
