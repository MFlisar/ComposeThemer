...
object ThemeRustDeepOrange {
    ...
    const val KEY = "Rust Deep Orange"
    ...
    private val Light = lightColorScheme(
        ...
        surfaceTint = Color(0xFFBF360C), // copied from: primary
    ...
    private val Dark = darkColorScheme(
        ...
        inversePrimary = Color(0xFF6A524A),
        surfaceTint = Color(0xFFFFB5A0), // copied from: primary
