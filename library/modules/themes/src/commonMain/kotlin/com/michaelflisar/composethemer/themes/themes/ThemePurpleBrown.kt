...
object ThemePurpleBrown {
    ...
    private val Light = lightColorScheme(
        ...
        secondary = Color(0xFF60234F),
        onSecondary = Color(0xFFFFFFFF),
        secondaryContainer = Color(0xFFE9CEDD),
        onSecondaryContainer = Color(0xFF000000),
        tertiary = Color(0xFF4A0635),
        onTertiary = Color(0xFFFFFFFF),
        tertiaryContainer = Color(0xFFE3B0C5),
        ...
        surfaceTint = Color(0xFF450A0F), // copied from: primary
    ...
    private val Dark = darkColorScheme(
        ...
        secondary = Color(0xFF975384),
        onSecondary = Color(0xFFFFFFFF),
        secondaryContainer = Color(0xFF6A2357),
        onSecondaryContainer = Color(0xFFFFFFFF),
        tertiary = Color(0xFF5F4C5A),
        onTertiary = Color(0xFFFFFFFF),
        tertiaryContainer = Color(0xFF501A3C),
        ...
        inversePrimary = Color(0xFF4D3D3F),
        surfaceTint = Color(0xFFA98085), // copied from: primary
