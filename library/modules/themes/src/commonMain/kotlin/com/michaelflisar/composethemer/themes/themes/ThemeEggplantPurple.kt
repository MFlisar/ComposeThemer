...
object ThemeEggplantPurple {
    ...
    private val Light = lightColorScheme(
        ...
        surfaceTint = Color(0xFF9A25AE), // copied from: primary
    ...
    private val Dark = darkColorScheme(
        ...
        inversePrimary = Color(0xFF6A4E6A),
        surfaceTint = Color(0xFFF9ABFF), // copied from: primary
