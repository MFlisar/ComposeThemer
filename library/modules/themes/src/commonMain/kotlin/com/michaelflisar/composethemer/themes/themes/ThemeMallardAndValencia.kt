...
object ThemeMallardAndValencia {
    ...
    const val KEY = "Mallard And Valencia"
    ...
    private val Light = lightColorScheme(
        ...
        secondary = Color(0xFFD34B4B),
        onSecondary = Color(0xFFFFFFFF),
        secondaryContainer = Color(0xFFFFDAD6),
        onSecondaryContainer = Color(0xFF000000),
        tertiary = Color(0xFF959D33),
        onTertiary = Color(0xFFFFFFFF),
        tertiaryContainer = Color(0xFFE2E989),
        ...
        surfaceTint = Color(0xFF2D4421), // copied from: primary
    ...
    private val Dark = darkColorScheme(
        ...
        secondary = Color(0xFFE18686),
        onSecondary = Color(0xFF000000),
        secondaryContainer = Color(0xFF501116),
        onSecondaryContainer = Color(0xFFFFFFFF),
        tertiary = Color(0xFFC3C87A),
        onTertiary = Color(0xFF000000),
        tertiaryContainer = Color(0xFF454B00),
        ...
        inversePrimary = Color(0xFF3D423A),
        surfaceTint = Color(0xFF808E79), // copied from: primary
