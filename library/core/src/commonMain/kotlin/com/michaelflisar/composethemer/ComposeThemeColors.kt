...
interface ComposeThemeColors {
    ...
    fun lightSchemeMediumContrast() = lightColorScheme(
    ...
    fun darkSchemeMediumContrast() = darkColorScheme(
    ...
    fun lightSchemeHighContrast() = lightColorScheme(
    ...
    fun darkSchemeHighContrast() = darkColorScheme(
